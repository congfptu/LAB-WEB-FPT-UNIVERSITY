    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                request.setAttribute("error01", "This galery is invalid!!");
                invalid = false;
            }
            if (invalid == true) {
                int pageSize = 8;
                ...
                int index = 1;
                //check index page valid or not
                try {
                    if (pageIndex != null) {
                        index = Integer.parseInt(pageIndex);
                        if (index < 1 || index > totalPages) {
                            request.setAttribute("error03", "This page is invalid!");
                        }
                    }
                } catch (Exception e) {
                    request.setAttribute("error03", "This page is invalid!!");
                ...
                try {
                    ...
                    request.setAttribute("error04", "This image not found!!");
                }
                ...
                request.setAttribute("imgID", image);
            ...
            request.setAttribute("active", galery);
