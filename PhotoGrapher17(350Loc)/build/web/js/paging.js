...
function renderPagerImage(id, pageindex,galeryID,imgID,totalpage, gap)
{
    //get container of id 
    var container = document.getElementById(id);
    var i;
    var begin = "<a href='gallery?galeryID="+galeryID+"&imgID="+imgID+"&index=";
